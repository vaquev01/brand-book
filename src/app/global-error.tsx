...
export default function GlobalError({
  ...
  return (
    <html lang="pt-BR">
      <body className="min-h-screen flex items-center justify-center bg-gray-50" style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
        <div className="text-center max-w-lg p-8">
          ...
          <button
            onClick={reset}
            className="inline-flex items-center gap-2 bg-violet-600 hover:bg-violet-700 text-white px-6 py-3 rounded-xl font-semibold text-sm transition-colors"
          >
            Tentar novamente
          </button>
        </div>
