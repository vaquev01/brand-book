            ...
            {[
              {
                ...
                desc: "O sistema pensa como Paula Scher, Sagmeister e David Carson. Cada prompt avaliado com scorecard de coerência.",
                accent: "#6366f1",
              },
              {
                title: "Modo Imersivo",
                desc: "O brandbook se veste da marca: cores, tipografia, texturas e linguagem em primeira pessoa.",
                accent: "#f59e0b",
              },
              {
                title: "Apresentação Cinematográfica",
                desc: "Modo fullscreen com transições suaves para apresentar ao cliente como um keynote.",
                accent: "#ef4444",
              },
              {
                title: "24 Seções Editoriais",
                desc: "DNA, posicionamento, personas, verbal identity, logo, cores, tipografia, aplicações e mais.",
                accent: "#22c55e",
              },
              {
                title: "Multi-Provider",
                desc: "DALL-E 3, Stability AI, Ideogram e Imagen 3 geram assets visuais coerentes com a proposta.",
                accent: "#3b82f6",
              },
              {
                title: "Exportação Pro",
                desc: "PDF multi-página, ZIP com assets, Design Tokens (CSS/W3C/Tailwind) e share link.",
                accent: "#a855f7",
              },
            ].map((f) => (
              <div
